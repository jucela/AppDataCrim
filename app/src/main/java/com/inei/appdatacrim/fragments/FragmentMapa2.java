...
public class FragmentMapa2 extends Fragment implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
...
//        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(comisaria).title("Mi Ubicacion").snippet("Av. Garzon 523").icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_action_location_2)));

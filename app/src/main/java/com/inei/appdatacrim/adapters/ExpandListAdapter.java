package com.inei.appdatacrim.adapters;
...
//            {textView.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_START);}
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        iconos.add(R.drawable.ic_action_shield);
        iconos.add(R.drawable.ic_place);
        iconos.add(R.drawable.ic_action_home);
        iconos.add(R.drawable.ic_pie_chart);
        ...
        imageView.setImageResource(iconos.get(groupPosition));
        return convertView;
    }
